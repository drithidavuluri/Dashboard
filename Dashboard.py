...
# Create a placeholder for the home page elements
home_page_placeholder = st.empty()

def home_page():
    with home_page_placeholder:
        # Title
        ...
        with text_container:
            st.write("Welcome to the Social Media Analysis application.")
            st.write("Select a dashboard below to get started.")
        ...
        with col1:
            if st.button("YouTube Dashboard"):
                selected_page = "YouTube Dashboard"
        with col2:
            if st.button("Instagram Dashboard"):
                selected_page = "Instagram Dashboard"
        with col3:
            if st.button("Comparison Dashboard"):
                selected_page = "Comparison Dashboard"

        # Initialize selected_page if no button is clicked
...
if selected_page is None:
    # If no dashboard is selected, show the home page
    pass
else:
    # If a dashboard is selected, hide the home page elements
    home_page_placeholder.empty()

    if selected_page == "YouTube Dashboard":
        youtube_dashboard()
    elif selected_page == "Instagram Dashboard":
        instagram_dashboard()
